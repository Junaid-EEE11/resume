...
description: Internal fixture for cross-plugin and visual regression tests.
...
<aside>
  <p>Images and explanatory text can also be placed inside a sidenote.</p>
</aside>
